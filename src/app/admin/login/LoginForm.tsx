...
export default function LoginForm({ passwordHint }: { passwordHint: string }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-[0_4px_24px_-6px_rgba(0,0,0,0.12)] ring-1 ring-black/6">
        ...
        <p className="mt-5 rounded-lg bg-neutral-50 px-3.5 py-2.5 text-center font-mono text-[12px] text-neutral-500 ring-1 ring-black/6">
          {passwordHint}
        </p>
      </div>
    </div>
